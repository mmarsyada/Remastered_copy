...
function RebelHideoutScreenPlay:spawnMobiles()
	...
	--Rebel Defense Droid Placements
	spawnMobile("corellia", "gcw_rebel_defense_droid", 300, -6559.9, 405.0, 5920.3, 168, 0)
	spawnMobile("corellia", "gcw_rebel_defense_droid", 300, -6477.1, 405.0, 5906.9, 73, 0)
	spawnMobile("corellia", "gcw_rebel_defense_droid", 300, 6428.3, 405.0, 6039.0, -34, 0)

	-- South Entrance
	spawnMobile("corellia", "specforce_squad_leader_sentry", 300, -6560.940, 405.000, 5927.760, 138.910, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6556.8, 405.0, 5926.1, 140, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6564.2, 405.0, 5928.9, 136, 0)
	spawnMobile("corellia", "specforce_bombardier_sentry", 300, -6566.3, 405.0, 5936.8, 176, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6417.8, 405.0, 6023.4, 150, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6423.3, 405.0, 6032.5, -22, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6426.9, 405.0, 6031.4, -25, 0)
	spawnMobile("corellia", "specforce_sniper_sentry", 300, -6427.5, 405.0, 6024.2, 17, 0)
...
--	spawnMobile("corellia", "specforce_sentry", 300, -6483.2 405.0, 5908.8, 77, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6482.8, 405.2, 5901.8, 76, 0)
	spawnMobile("corellia", "specforce_bombardier_sentry", 300, -6491.8, 405.0, 5907.6, 110, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6558.7, 405.0, 5937.3, -135, 0)
	spawnMobile("corellia", "specforce_bombardier_sentry", 300, -6443.2, 403.2, 6018.2, 68, 0)
--	spawnMobile("corellia", "specforce_rebel_major_sentry", 300, -6446.6, 403.2, 6021.5, 68, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6454.1, 398.0, 6011.7, -114, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6456.8, 398.0, 6017.6, -114, 0)
	
	-- South East Stairs
	spawnMobile("corellia", "specforce_sentry", 300, -6492.260, 398.000, 5939.580, 11.765, 0)
	spawnMobile("corellia", "rebel_major_sentry", 300, -6498.480, 398.000, 5938.420, 10.799, 0)
	
	-- Southeast Ramp
	spawnMobile("corellia", "specforce_sentry", 300, -6489.260, 405.000, 5916.220, 162.333, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6493.550, 405.000, 5915.540, 163.230, 0)
--	spawnMobile("corellia", "specforce_sniper_sentry", 300, -6494.0 403.0, 5926.7, 171, 0)
	spawnMobile("corellia", "specforce_combat_medic_sentry", 300, -6491.8, 403.0, 5926.9, 171, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6525.8, 398.0, 5975.5, -137, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6520.8, 398.0, 5970.6, -128, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6451.3, 398.0, 5975.9, -45, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6464.1, 398.0, 5963.1, 43, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6464.5, 398.0, 5960.8, -136, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6533.2, 398.0, 6039.5, 164, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6520.1, 398.0, 6044.0, 167, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6509.8, 398.0, 6022.2, -5, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6514.4, 398.0, 6021.8, -45, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6521.8, 398.0, 6014.0, -45, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6496.5, 398.0, 6022.4, -59, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6490.0, 405.0, 6010.0, 132, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6486.4, 404.9, 6006.0, -41, 0)
	spawnMobile("corellia", "specforce_squad_leader_sentry", 300, 6483.6, 404.9, 6009.7, -46, 0)

	-- Mission Terminal by Stairs

	spawnMobile("corellia", "specforce_sentry", 300, -6485.1, 398.0, 6014.8, 46, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6485.4, 398.0, 6006.5, 126, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6489.9, 398.0, 6010.8, -45, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6485.7, 398.0, 6011.0, -131, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6529.1, 405.0, 5979.6, 132, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6531.9, 405.0, 5982.4, -44, 0)
	...
	spawnMobile("corellia", "specforce_sentry", 300, -6476.6, 398.0, 6033.0, -154, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6480.4, 398.0, 6035.1, -157, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6497.6, 398.0, 6041.3, -165, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6501.8, 398.0, 6042.2, -167, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6542.0, 398.0, 6028.3, 132, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6544.8, 398.0, 6025.2, 132, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6552.0, 398.0, 6007.0, 99, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6552.6, 398.0, 6002.6, 100, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6484.5, 398.0, 5961.8, 44, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6487.4, 398.0, 5964.7, 44, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6477.5, 398.0, 5974.7, -134, 0)
	spawnMobile("corellia", "specforce_sentry", 300, -6474.7, 398.0, 5971.8, -135, 0)
