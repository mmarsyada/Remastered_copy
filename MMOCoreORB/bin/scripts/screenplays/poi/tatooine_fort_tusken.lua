...
function FortTuskenScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "tusken_executioner",3600, -1.54, 1.58, 0.90,-102,1189175)
	...
	spawnMobile("tatooine", "tusken_witch_doctor",3600,2.17, 8.36, -32.02,118,1189178)
	spawnMobile("tatooine", "tusken_executioner", 3600, 6.54, 8.0, -34.17, 180, 1189178)
	spawnMobile("tatooine", "tusken_observer",600,8.5,8.2,-33.5,0,1189178)
	spawnMobile("tatooine", "tusken_observer",600,1.2,8.15,-20.5,0,1189178)
	spawnMobile("tatooine", "tusken_observer",600,3.07, 8.31, -39.26,0,1189178)
