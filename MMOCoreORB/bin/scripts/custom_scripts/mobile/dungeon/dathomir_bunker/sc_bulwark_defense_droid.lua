sc_bulwark_defense_droid = Creature:new {
	customName = "Shadow Collective Defense Droid",
...
CreatureTemplates:addCreatureTemplate(sc_bulwark_defense_droid, "sc_bulwark_defense_droid")
