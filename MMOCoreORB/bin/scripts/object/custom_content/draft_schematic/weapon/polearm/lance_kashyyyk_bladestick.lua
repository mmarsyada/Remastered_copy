object_draft_schematic_weapon_lance_kashyyyk_bladestick = object_draft_schematic_weapon_shared_lance_kashyyyk_bladestick:new {
   ...
   ingredientTitleNames = {"lance_shaft", "vibro_unit_and_power_cell_brackets", "grip", "axe_head", "kashyyyk_blade", "reinforcement_core"},
   ingredientSlotType = {0, 0, 0, 0, 1, 1},
   resourceTypes = {"iron_kammris", "steel", "metal", "copper", "object/tangible/component/weapon/shared_kashyyyk_blade.iff", "object/tangible/component/weapon/shared_sword_core.iff"},
