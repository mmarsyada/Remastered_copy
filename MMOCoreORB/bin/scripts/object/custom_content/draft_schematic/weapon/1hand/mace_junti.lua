...
object_draft_schematic_weapon_sword_junti_mace = object_draft_schematic_weapon_shared_sword_junti_mace:new {
   ...
   ingredientTitleNames = {"grip_unit", "conductive_strike_face", "power_cell_brackets", "charge_accumulator", "junti_power_conditioner", "reinforcement_core"},
   ingredientSlotType = {0, 0, 0, 0, 1, 1},
   resourceTypes = {"copper_polysteel", "steel", "metal", "crystalline_byrothsis", "object/tangible/component/weapon/shared_eventide_mace_head.iff", "object/tangible/component/weapon/shared_reinforcement_core.iff"},
