object_draft_schematic_armor_armor_appearance_stormtrooper_bracer_r_gcw = object_draft_schematic_armor_shared_armor_appearance_stormtrooper_bracer_r_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Refurbished Stormtrooper Armor Right Bracer",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_stormtrooper_bracer_r_gcw, "object/draft_schematic/armor/armor_appearance_stormtrooper_bracer_r_gcw.iff")
