object_draft_schematic_armor_armor_appearance_stormtrooper_helmet_gcw = object_draft_schematic_armor_shared_armor_appearance_stormtrooper_helmet_gcw:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Refurbished Stormtrooper Armor Helmet",
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_appearance_stormtrooper_helmet_gcw, "object/draft_schematic/armor/armor_appearance_stormtrooper_helmet_gcw.iff")
