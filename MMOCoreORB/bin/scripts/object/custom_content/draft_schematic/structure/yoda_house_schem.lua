...
object_draft_schematic_structure_yoda_house_schem = object_draft_schematic_structure_shared_yoda_house_schem:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_yoda_house_schem, "object/draft_schematic/structure/yoda_house_schem.iff")
