...
includeFile("installation/mining_liquid/mining_liquid_moisture_harvester.lua")
...
includeFile("installation/mining_liquid/mining_liquid_moisture_harvester_elite.lua")
