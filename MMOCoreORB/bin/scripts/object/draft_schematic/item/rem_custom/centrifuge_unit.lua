object_draft_schematic_item_rem_custom_centrifuge_unit = object_draft_schematic_item_rem_custom_shared_centrifuge_unit:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_item_rem_custom_centrifuge_unit, "object/draft_schematic/item/rem_custom/centrifuge_unit.iff")
