object_draft_schematic_item_rem_custom_centrifuge_use_tray = object_draft_schematic_item_rem_custom_shared_centrifuge_use_tray:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_item_rem_custom_centrifuge_use_tray, "object/draft_schematic/item/rem_custom/centrifuge_use_tray.iff")
