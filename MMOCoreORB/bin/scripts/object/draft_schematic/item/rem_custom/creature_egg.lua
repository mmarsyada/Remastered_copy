object_draft_schematic_item_rem_custom_creature_egg = object_draft_schematic_item_rem_custom_shared_creature_egg:new {
	...
	targetTemplate = "object/tangible/rem_custom/statted/creature_egg.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_item_rem_custom_creature_egg, "object/draft_schematic/item/rem_custom/creature_egg.iff")
