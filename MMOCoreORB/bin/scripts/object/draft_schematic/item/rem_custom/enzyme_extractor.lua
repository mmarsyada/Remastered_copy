object_draft_schematic_item_rem_custom_enzyme_extractor = object_draft_schematic_item_rem_custom_shared_enzyme_extractor:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_item_rem_custom_enzyme_extractor, "object/draft_schematic/item/rem_custom/enzyme_extractor.iff")
