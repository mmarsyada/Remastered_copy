object_draft_schematic_item_rem_custom_combiner_unit = object_draft_schematic_item_rem_custom_shared_combiner_unit:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_item_rem_custom_combiner_unit, "object/draft_schematic/item/rem_custom/combiner_unit.iff")
