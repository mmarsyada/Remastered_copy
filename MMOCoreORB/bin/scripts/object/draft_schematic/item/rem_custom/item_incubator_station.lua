object_draft_schematic_item_rem_custom_item_incubator_station = object_draft_schematic_item_rem_custom_shared_item_incubator_station:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_item_rem_custom_item_incubator_station, "object/draft_schematic/item/rem_custom/item_incubator_station.iff")
