object_draft_schematic_structure_gen_md_win_02_schem = object_draft_schematic_structure_shared_gen_md_win_02_schem:new {
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/generic_medium_window_s02_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_gen_md_win_02_schem, "object/draft_schematic/structure/gen_md_win_02_schem.iff")
