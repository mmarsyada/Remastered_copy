object_draft_schematic_furniture_rem_custom_wall_panel_schematic_06 = object_draft_schematic_furniture_rem_custom_shared_wall_panel_schematic_06:new {
	...
	additionalTemplates = {
		...
		"object/tangible/rem_custom/decorative/shared_poi_aurilia_rodian_hut_walltrim.iff",
		"object/tangible/borrie/wall/shared_hospital_wall_details_horiz_phong.iff"
	}
}
ObjectTemplates:addTemplate(object_draft_schematic_furniture_rem_custom_wall_panel_schematic_06, "object/draft_schematic/furniture/rem_custom/wall_panel_schematic_06.iff")
