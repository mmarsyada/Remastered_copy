object_draft_schematic_furniture_rem_custom_aurebesh_leth = object_draft_schematic_furniture_rem_custom_shared_aurebesh_leth:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_furniture_rem_custom_aurebesh_leth, "object/draft_schematic/furniture/rem_custom/aurebesh_leth.iff")
