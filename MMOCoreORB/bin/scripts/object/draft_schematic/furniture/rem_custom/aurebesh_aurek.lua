object_draft_schematic_furniture_rem_custom_aurebesh_aurek = object_draft_schematic_furniture_rem_custom_shared_aurebesh_aurek:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_furniture_rem_custom_aurebesh_aurek, "object/draft_schematic/furniture/rem_custom/aurebesh_aurek.iff")
