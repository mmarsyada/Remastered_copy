object_draft_schematic_furniture_rem_custom_aurebesh_peth = object_draft_schematic_furniture_rem_custom_shared_aurebesh_peth:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_furniture_rem_custom_aurebesh_peth, "object/draft_schematic/furniture/rem_custom/aurebesh_peth.iff")
