object_draft_schematic_furniture_rem_custom_aurebesh_usk = object_draft_schematic_furniture_rem_custom_shared_aurebesh_usk:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_furniture_rem_custom_aurebesh_usk, "object/draft_schematic/furniture/rem_custom/aurebesh_usk.iff")
