object_draft_schematic_weapon_carbine_proton_elite = object_draft_schematic_weapon_shared_carbine_proton_elite:new {
   ...
   ingredientTitleNames = {"frame_assembly", "receiver_assembly", "grip_assembly", "powerhandler", "coil_carbine_proton","barrel", "scope", "stock", "powerhandler"},
   ...
   resourceQuantities = {65, 30, 12, 4, 1, 1, 1, 1, 2},
