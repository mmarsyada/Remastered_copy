...
object_draft_schematic_weapon_rifle_proton_elite = object_draft_schematic_weapon_shared_rifle_proton_elite:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Elite Proton Rifle",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_rifle_proton_elite, "object/draft_schematic/weapon/rifle_proton_elite.iff")
