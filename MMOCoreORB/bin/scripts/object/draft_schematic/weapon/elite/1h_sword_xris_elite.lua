object_draft_schematic_weapon_1h_sword_xris_elite = object_draft_schematic_weapon_shared_1h_sword_xris_elite:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Elite Xris Acid Sword",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_1h_sword_xris_elite, "object/draft_schematic/weapon/1h_sword_xris_elite.iff")
