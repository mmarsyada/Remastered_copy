...
object_draft_schematic_weapon_pistol_ion_relic_elite = object_draft_schematic_weapon_shared_pistol_ion_relic_elite:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Elite ION Relic Schematic",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_pistol_ion_relic_elite, "object/draft_schematic/weapon/pistol_ion_relic_elite.iff")
