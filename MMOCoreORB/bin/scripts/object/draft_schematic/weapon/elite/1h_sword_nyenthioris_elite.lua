object_draft_schematic_weapon_1h_sword_nyenthioris_elite = object_draft_schematic_weapon_shared_1h_sword_nyenthioris_elite:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Elite Blade of Nyenthi'oris",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_1h_sword_nyenthioris_elite, "object/draft_schematic/weapon/1h_sword_nyenthioris_elite.iff")
