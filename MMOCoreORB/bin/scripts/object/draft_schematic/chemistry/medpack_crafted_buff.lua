...
object_draft_schematic_chemistry_medpack_crafted_buff = object_draft_schematic_chemistry_shared_medpack_crafted_buff:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Enhance All Attributes Medpack",
...
ObjectTemplates:addTemplate(object_draft_schematic_chemistry_medpack_crafted_buff, "object/draft_schematic/chemistry/medpack_crafted_buff.iff")
