...
object_draft_schematic_armor_armor_jedi_guardian_chest_plate = object_draft_schematic_armor_shared_armor_jedi_guardian_chest_plate:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Jedi Guardian Armor Chest Plate",
