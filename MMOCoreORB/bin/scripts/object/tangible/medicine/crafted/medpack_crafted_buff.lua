...
object_tangible_medicine_crafted_shared_crafted_buff = object_tangible_medicine_crafted_shared_crafted_buff:new {
	gameObjectType = 8238,
	...
	experimentalMin = {0, 0, 40, 2, 1200, 100, 1000},
	experimentalMax = {0, 0, 700, 12, 14200, 70, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 4},
}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_shared_crafted_buff, "object/tangible/medicine/crafted/medpack_crafted_buff.iff")
