...
object_tangible_loot_loot_schematic_death_watch_bounty_hunter_boots_schematic = object_tangible_loot_loot_schematic_shared_death_watch_bounty_hunter_boots_schematic:new {
	templateType = LOOTSCHEMATIC,
	customName = "Bounty Hunter Armor Boots Schematic",
