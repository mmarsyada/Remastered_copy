object_tangible_loot_loot_schematic_backpack_s03_elite_schematic = object_tangible_loot_loot_schematic_shared_backpack_s03_elite_schematic:new {
	templateType = LOOTSCHEMATIC,
	customName = "Elite Military Travel Pack Schematic",
