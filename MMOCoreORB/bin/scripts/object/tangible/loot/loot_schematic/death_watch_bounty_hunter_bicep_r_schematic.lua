...
object_tangible_loot_loot_schematic_death_watch_bounty_hunter_bicep_r_schematic = object_tangible_loot_loot_schematic_shared_death_watch_bounty_hunter_bicep_r_schematic:new {
	templateType = LOOTSCHEMATIC,
	customName = "Bounty Hunter Armor Right Bicep Schematic",
