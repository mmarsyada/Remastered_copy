object_tangible_loot_loot_schematic_ep3_chiss_poacher_backpack_schematic = object_tangible_loot_loot_schematic_shared_ep3_chiss_poacher_backpack_schematic:new {
	templateType = LOOTSCHEMATIC,
	customName = "Chiss Poacher Backpack Schematic",
