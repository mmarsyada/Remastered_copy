...
object_tangible_wearables_wookiee_wke_lifeday_robe_m = object_tangible_wearables_wookiee_shared_wke_lifeday_robe_m:new {
...
ObjectTemplates:addTemplate(object_tangible_wearables_wookiee_wke_lifeday_robe_m, "object/tangible/wearables/wookiee/wke_lifeday_robe_m.iff")
