...
ObjectTemplates:addTemplate(object_tangible_wearables_backpack_back_love_day_10_pink_wings, "object/tangible/wearables/backpack/back_love_day_10_pink_wings.iff")
