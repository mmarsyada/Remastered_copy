object_tangible_rem_custom_statted_drink_wed_scav_reward_scotch = object_tangible_rem_custom_statted_shared_drink_wed_scav_reward_scotch:new {
...
ObjectTemplates:addTemplate(object_tangible_rem_custom_statted_drink_wed_scav_reward_scotch, "object/tangible/rem_custom/statted/drink_wed_scav_reward_scotch.iff")
