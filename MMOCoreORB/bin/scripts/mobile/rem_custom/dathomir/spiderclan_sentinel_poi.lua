spiderclan_sentinel_poi = Creature:new {
	...
	baseHAMmax = 26000,
	armor = 1,
	resists = {55,100,45,60,100,100,35,100,40},
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
...
CreatureTemplates:addCreatureTemplate(spiderclan_sentinel_poi, "spiderclan_sentinel_poi")
