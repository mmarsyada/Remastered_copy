janta_soothsayer_elite = Creature:new {
	customName = "ELITE Janta Soothsayer",
...
CreatureTemplates:addCreatureTemplate(janta_soothsayer_elite, "janta_soothsayer_elite")
