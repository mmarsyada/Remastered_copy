...
includeFile("dantooine/elder_walluga.lua")
includeFile("dantooine/frenzied_walluga.lua")
includeFile("dantooine/noxious_walluga.lua")
includeFile("dantooine/walluga_skullsmasher.lua")
includeFile("dantooine/walluga_skullsmasher_veteran.lua")
