...
forcepowermaster = { {"forcelightningsingle2",""},{"forcelightningcone2",""},{"mindblast2",""},{"forceknockdown2",""},{"forceweaken2",""},{"forcethrow2",""},{"forcechoke",""},{"forceLightningStorm",""} }
...
--Chiss Poacher Skills
chisscommando = { {"flamecone2",""},{"flamesingle2",""},{"fireacidcone2",""},{"fireacidsingle2",""} }
chisssmuggler = { {"healthshot1",""},{"bodyshot1",""},{"pistolmeleedefense2",""},{"disarmingshot2",""},{"doubletap",""},{"stoppingshot",""},{"fanshot",""} }
